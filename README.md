...
- Mount volumes
  - The users are chrooted to home directory, so you can mount the
    volumes in separate directories inside the home or user's home directory
    (/home/user/**mounted-directory**) or just mount the whole **/home/user** directory.
    Just remember that the users can't create new files directly under home directory, 
    so make sure there are at least one subdirectory if you
